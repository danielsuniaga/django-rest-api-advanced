...
class PublicUserApiTest(TestCase):
    ...
    """ Testear API publico del usuario """
    ...
    def test_create_valid_user_success(self):
        ...
        """ Probar craer usuario con un payload exitoso """
    ...
    def test_create_token_no_user(self):
        ...
        """ Prueba que el token no es creado si no existe un usuario """
    ...
    def test_retrieve_user_unauthoriczed(self):

        """Probar que la autenticación sea requerida por los usuarios"""
...
class PrivateUserApiTest(TestCase):
    ...
    """ Testear el API Private del usuario """
